...
1. **Secure a charter** → monopoly + legal cover.
2. **Build a fort chain** → ports, warehouses, repair yards, cannon.
3. **Turn trade into force** → armed convoys, blockades, “inspection,” seizure.
4. **Make treaties like a state** → alliances with local rulers; divide rivals.
5. **Convert commerce into governance** → courts, taxes, police, forced labor.
6. **Scale extraction** → plantations, mines, slave trade; stabilize with violence.
